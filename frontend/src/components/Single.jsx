...
import port1 from './image/post-1.jpg'
import port2 from './image/post-2.jpg'
import port3 from './image/post-3.jpg'
import user from './image/user.jpg'
import details from './image/detail.jpg'
    ...
    <div className="row pt-5">
      <div className="col-lg-8">
        ...
        <div className="mb-5">
          ...
          <div className="media mb-4 lileft">
            <img
              src={user}
              alt="Image"
          ...
          <div className="media mb-4 lileft">
            ...
            <div className="media-body">
              ...
              <button className="btn btn-sm btn-light">Reply</button>
              <div className="media mt-4 lileft">
                <img
                  src={user}
                  alt="Image"
                  className="img-fluid rounded-circle mr-3 mt-1"
      ...
      <div className="col-lg-4 mt-5 mt-lg-0">
        {/* Author Bio */}
        <div className="d-flex flex-column text-center bg-primary rounded mb-5 py-5 px-4 lileft">
          <img
            src={user}
